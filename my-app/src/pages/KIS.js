		...
		<div className='body-form' style={{ height: "100%" }} >
			...
			<div className='data-container'>
				<div style={{ width: '100%' }}>
					...
					<h2>손익계산서</h2>
					{profitLoss.length > 0 ? (
						<table border="1" style={{ borderCollapse: 'collapse', tableLayout: 'fixed', marginTop: '20px', width: '60%' }}>
					...
					<h2 style={{ marginTop: '50px' }}>재무비율</h2>
					{financialRatio.length > 0 ? (
						<table border="1" style={{ backgroundColor: '#f2f2f2', borderCollapse: 'collapse', tableLayout: 'fixed', marginTop: '20px', width: '90%' }}>
							<thead style={{ backgroundColor: '#ffffff' }}>
								<tr>
					...
					<div style={{ display: 'flex', justifyContent: 'flex-start', marginTop: '50px', paddingBottom: '30px' }}>
						<div style={{ flex: 1, textAlign: 'left' }}>
							<h2>시가총액 순위</h2>
							<table border="1" style={{ backgroundColor: '#f2f2f2', borderCollapse: 'collapse', tableLayout: 'fixed', marginTop: '20px' }}>
								<thead style={{ backgroundColor: '#ffffff' }}>
									<tr>
